...
<div class="card-body">
  ...
  <a href="?url=rifki_verifikasi" class="btn btn-primary btn-icon-split">
   ...
   <a href="rifki_proses.php?id=<?php echo $data['rifki_id_pengaduan']; ?>" class="btn btn-danger btn-icon-split" onclick="return confirm('Yakin Mau Proses Verifikasi Status')">
    <span class="icon text-white-50">
      <i class="fas fa-check"></i>
    </span>
    <span class="text">Tanggapan Verifikasi Status</span>
  </a>
  ...
  <div class="card-body">
    <form action="rifki_simpanpengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="form-group cols-sm-6">
        ...
        <input type="text" value="<?php echo $data['rifki_id_pengaduan']; ?>" class="form-control" readonly>
      </div>
      <div class="form-group cols-sm-6">
      ...
      <div class="form-group cols-sm-6">
       ...
       <div class="form-group cols-sm-6">
        ...
        <br>
        <img src="../foto/<?php echo $data['rifki_foto']; ?>" style="width: 500px">
      </div>
