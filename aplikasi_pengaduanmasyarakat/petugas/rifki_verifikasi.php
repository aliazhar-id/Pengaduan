            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  $query = mysqli_query($koneksi,"SELECT * FROM rifki_pengaduan WHERE rifki_status='belum' limit $halaman_awal, $batas");
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="rifki_petugas.php?url=rifki_tanggapan&id=<?php echo $data['rifki_id_pengaduan']; ?>" class="btn btn-success btn-icon-split">
                        <span class="icon text-white-50">
                    <i class="fas fa-check"></i>
                          </span>
