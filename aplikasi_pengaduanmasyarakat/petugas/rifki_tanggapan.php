...
<div class="card-body">
  <div class="card_header">
    <h3>Tanggapan Verifikasi Status Pengaduan</h3>
  </div>
  <div class="card-body">
  ...
  <div class="card-body">
    <form action="rifki_simpantanggapan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="form-group cols-sm-6">
        ...
        <input type="text" name="rifki_tgl" value="<?php echo date('d-m-Y') ?>" class="form-control" readonly>
      </div>

      <div class="form-group cols-sm-6">
        <label>Isi Tanggapan</label>
        <textarea class="form-control" rows="7" name="rifki_tanggapanptgs">
        </textarea>
      </div>
