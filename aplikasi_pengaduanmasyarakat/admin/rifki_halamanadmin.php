...
if (isset($_GET['url'])) {
	...
	switch ($url) {
		...
		case 'rifki_lihatpetugas':
		include 'rifki_lihatpetugas.php';
		break;

		case 'rifki_lihatmasyarakat':
		include 'rifki_lihatmasyarakat.php';
		break;

		case 'rifki_lihatpengaduan':
		include 'rifki_lihatpengaduan.php';
		break;

		case 'rifki_lihattanggapan':
		include 'rifki_lihattanggapan.php';
		break;

    case 'rifki_lihattanggapanptgs':
    include 'rifki_lihattanggapanptgs.php';
    break;

		case 'rifki_tambahpetugas':
		include 'rifki_tambahpetugas.php';
		break;

		case 'rifki_editpetugas':
		include 'rifki_editpetugas.php';
		break;

		case 'rifki_editmasyarakat':
		include 'rifki_editmasyarakat.php';
		break;

		case 'rifki_edittanggapan':
		include 'rifki_edittanggapan.php';
		break;

    case 'rifki_edittanggapanptgs':
    include 'rifki_edittanggapanptgs.php';
    break;

		case 'rifki_deletepetugas':
		include 'rifki_deletepetugas.php';
		break;

		case 'rifki_deletemasyarakat':
		include 'rifki_deletemasyarakat.php';
		break;

		case 'rifki_deletetanggapan':
		include 'rifki_deletetanggapan.php';
		break;

		case 'rifki_deletepengaduan':
		include 'rifki_deletepengaduan.php';
		break;

		case 'report_petugas':
		include 'report_petugas.php';
		break;

		case 'report_masyarakat':
		include 'report_masyarakat.php';
		break;

		case 'report_tanggapan':
		include 'report_tanggapan.php';
		break;
		...
		case 'rifki_reportpengaduan':
		include 'rifki_reportpengaduan.php';
		break;

		case 'percobaan_report':
		include 'percobaan_report.php';
		break;
	...
	Anda Login Sebagai :</h5> <h2><b> <?php  echo $_SESSION["rifki_nama_petugas"];

	include '../rifki_koneksi.php';
	$sql = mysqli_query($koneksi, "SELECT * FROM rifki_pengaduan where rifki_status='proses'");
