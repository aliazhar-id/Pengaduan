            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  $data = mysqli_query($koneksi,"select * from rifki_tanggapanptgs");
                  $jumlah_data = mysqli_num_rows($data);
                  $total_halaman = ceil($jumlah_data / $batas);
                  $no_urut = 0;
                  $cari = @$_POST['cari'];
                  $sql = mysqli_query($koneksi,"SELECT * FROM rifki_tanggapanptgs WHERE rifki_tgl LIKE '%$cari%' limit $halaman_awal, $batas");
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo $data['rifki_tgl']?></td>
                      <td><?php echo $data['rifki_tanggapanptgs']?></td>
                      <td>
                        <a href="rifki_admin.php?url=rifki_edittanggapanptgs&id=<?php echo $data['rifki_id_tgpan']; ?>" class="btn btn-primary btn-circle" onclick="return confirm('Yakin Mau Edit Data?')">
                          <i class="fa fa-edit"></i>
                        </a>

                        <a href="rifki_deletetanggapanptgs.php?id=<?php echo $data['rifki_id_tgpan']?>" class="btn btn-danger btn-circle" onclick="return confirm('Yakin Mau Hapus Data?')">
