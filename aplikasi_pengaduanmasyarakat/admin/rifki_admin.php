      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?url=rifki_lihattanggapan">Data Tanggapan Admin</a>
            <a class="collapse-item" href="?url=rifki_lihattanggapanptgs">Data Tanggapan Petugas</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <?php include 'rifki_halamanadmin.php'; ?>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="rifki_login2.php">Logout</a>
        </div>
      </div>
    </div>
  </div>
