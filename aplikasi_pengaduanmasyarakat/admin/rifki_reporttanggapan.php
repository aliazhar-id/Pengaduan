...
<body id="page-top">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <h6 class="m-0 font-weight-bold text-secondary" align="center">Jl.Kalidam No.6 Rt.01 / Rw.09 Kel. Karangmekar Kec. Cimahi Tengah kode Pos 04523 Kota Cimahi Jawa Barat, Indonesia.</h6>
              <br><br><hr>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  $sql = mysqli_query($koneksi,"SELECT * FROM rifki_tanggapan");
                  ...
                  ?>
                    ...
                    <tr>
                       <td><?php echo $data['rifki_id_tanggapan']?></td>
                      <td><?php echo $data['rifki_id_pengaduan']?></td>
                      <td><?php echo $data['rifki_tgl_tanggapan']?></td>
                      <td><?php echo $data['rifki_tanggapan']?></td>
                      <td><?php echo $data['rifki_id_petugas']?></td>
