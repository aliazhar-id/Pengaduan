...
<div class="card-body">
  ...
  <div class="card-body">
    <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
      ...
      $sql=mysqli_query($koneksi, "SELECT * FROM rifki_pengaduan, rifki_tanggapan where rifki_tanggapan.rifki_id_pengaduan='$_GET[id]' and rifki_tanggapan.rifki_id_pengaduan=rifki_pengaduan.rifki_id_pengaduan");
      ...
      <div class="form-group cols-sm-6">
        ...
        <input type="text" name="rifki_tgl_pengaduan" value="<?php echo $data['rifki_tgl_tanggapan']; ?>" class="form-control" readonly>
      </div>
